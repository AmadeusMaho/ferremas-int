...
urlpatterns = [
    ...
    path('modificarProducto/', views.modificarProductoLista, name='modificarProductoLista'),
    path('modificarProducto/modificarStock', views.modificarStock, name='modificarStock')
]
